...
int main() {
	...
	printf("1. ÀÎÅ¥ 2. µðÅ¥ 3. ÇÁ¸°Æ® else. Á¾·á \nÀÔ·Â : ");
...
int main() {
	...
	int n, value;
	printf("1.»ðÀÔ 2.»èÁ¦ 3.Ãâ·Â (0ÀÌ³ª ¼ýÀÚ°¡ ¾Æ´Ñ °ÍÀ» ÀÔ·ÂÇÒ½Ã Á¾·á)\n");
	while (scanf("%d", &n)) {
		...
		case 0:
			...
			break;
		case 1:
			printf("»ðÀÔÇÒ ¼ýÀÚ ÀÔ·Â : ");
			scanf("%d", &value);
			create(head, value);
			break;
		case 2:
			printf("»èÁ¦ÇÒ ¼ýÀÚ ÀÔ·Â : ");
			scanf("%d", &value);
			NodeDelete(head, value);
			system("pause");
			break;
		case 3:
			printf("¸®½ºÆ®¸¦ ¹Ýº¹Ãâ·ÂÇÒ È½¼ö ÀÔ·Â : ");
			scanf("%d", &value);
		...
		system("cls");
		printf("1.»ðÀÔ 2.»èÁ¦ 3.Ãâ·Â (¼ýÀÚ°¡ ¾Æ´Ñ °ÍÀ» ÀÔ·ÂÇÒ½Ã Á¾·á)\n");
	}
...
int main() {
	headnode* head = createlisthead();
	int n,value;
	printf("1.»ðÀÔ 2.»èÁ¦ 3.Ãâ·Â 4.ÀüºÎ »èÁ¦ (¼ýÀÚ°¡ ¾Æ´Ñ °ÍÀ» ÀÔ·ÂÇÒ½Ã Á¾·á)\n");
	while (scanf("%d", &n)) {
...
int main() {
	...
	printf("\n");
	printf("¼ýÀÚ ¿©ºÎ (¾ç¼ö´Â »ðÀÔ À½¼ö´Â »èÁ¦ 0ÀÌ¸é Á¾·á)\n");
	do {
		scanf("%d %d", &n, &c);
		if (c < 0) {
			Delete(a, n);
...
int main() {
	...
	for (int i = 0; i < 5; i++) {
		printf("%d¹ø ÀúÃà±Ý¾×Àº? ", i + 1);
		scanf("%d", &F[i].won);
		F[i].number = i + 1;
	}
	money max = Max(F, 5);
	printf("ÀúÃà¿Õ %d¹ø %d¿ø", max.number, max.won);
}*/
...
int main() {
	human I = { "¾ç¼ºÈÆ",17 };
	human F;
	printf("Ä£ÇÑ Ä£±¸ÀÇ ÀÌ¸§°ú ³ªÀÌ¸¦ ÀÔ·ÂÇÏ¼¼¿ä");
	scanf("%s %d", F.name, &F.age);
	printf("´ç½ÅÀÇ ÀÌ¸§ : %s, ³ªÀÌ : %d \nÄ£±¸ÀÇ ÀÌ¸§ : %s, ³ªÀÌ : %d", I.name, I.age, F.name, F.age);
}*/
...
/*int main() {
	...
	printf("ÀÔ·Â¹ÞÀº ¹®ÀÚ¿­ÀÇ ±æÀÌ´Â %dÀÔ´Ï´Ù. \n%s", fin+1, c);
...
int main() {
	sturec s[5];
	for (int i = 0; i < 5; i++) {
		printf("ÇÐ»ýÀÇ ÇÐ¹ø ¼º¸í ±¹¾î ¿µ¾î ¼öÇÐ Á¡¼ö¸¦ ÀÔ·ÂÇÏ¼¼¿ä : ");
...
int main() {
	...
	printf("ÀÌ¸§  = %s %p \nÅ°   = %.1f %p \n¸ö¹«°Ô = %.1f %p \nÀåÇÐ±Ý = %d %p", student.name, &student.name, student.tall, &student.tall, student.weight, &student.weight, student.money, &student.money);
}*/
...
int main() {
	...
	printf("´ç½ÅÀÇ ÀÌ¸§: %s, ³ªÀÌ : %d \nÄ£±¸ÀÇ ÀÌ¸§: %s, ³ªÀÌ : %d", me.name, me.age, friends.name, friends.age);
}*/
...
int main() {
	...
	scanf("%s", human.name);
	printf("´ç½ÅÀÇ ³ªÀÌ´Â ¸î »ìÀÔ´Ï±î? ");
	scanf("%d", human.age);
	printf("´ç½ÅÀÇ ÀÌ¸§Àº %sÀÌ°í ³ªÀÌ´Â %d¼¼ÀÌ±º¿ä.", human.name, human.age);
}*/
...
int main() {
	int x, y;
	printf("2°³ Á¤¼ý°ªÀÇ ÃÖ´ë °ø¾à¼ö¸¦ ±¸ÇÕ´Ï´Ù.");

	scanf("%d %d", &x, &y);
	printf("ÃÖ´ë °ø¾à¼ö´Â %dÀÔ´Ï´Ù.", gcd(x, y));
}*/
...
int main() {
	...
	if (find >= 0) printf("%dÀº(´Â) %d¹øÂ°¿¡ ÀÖ½À´Ï´Ù.", key, find);
	else printf("Å½»ö¿¡ ½ÇÆÐÇß½À´Ï´Ù.");
}*/
...
/*void print(int grade[]) {
	printf("ÇÕ°ÝÀÚ ¸ñ·Ï\n");
	for (int i = 0; i < 7; i++) {
		if (grade[i] >= 60) printf("%d¹ø : %d\n", i + 1, grade[i]);
	}
}
int main() {
	int grade[7];
	printf("7¸íÀÇ Á¡¼ö¸¦ ÀÔ·ÂÇÏ½Ã¿À : \n");
	for (int i = 0; i < 7; i++){
		printf("%d : ", i + 1);
		scanf("%d", &grade[i]);
	}
...
/*int main() {
	...
	printf("ÇÕ°è	%d	%d	%d\n", langsum, mathsum, sum);
	printf("Æò±Õ	%f	%f	%f", (float)langsum / 6, (float)mathsum / 6, (float)sum / 6);
